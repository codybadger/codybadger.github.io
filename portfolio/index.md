...
Over the years, I've worked at a number of different places; from a doer of everything on a beer brewing machine, reliability testing on Tesla's Model S, destructive testing on 40-ton tractors, electric motorcycle design work, to municipal water supply design in El Salvador. Most of the info below can be found in my CV as well, but here are some of the brands I've worked with in the past:
